...
# PXR4 1
pxr4_1_d_id = d_id
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id,year) VALUES (" + str(
    d_id) + ", 11, 'PXR4 1', 2, 0, 11, 11,2012);")
...
# Sensor unit - top
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id,year) VALUES (" + str(
    d_id) + ", 10, 'NA', 404, 1, 12, " + str(s_top) + ",2012);")
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
...
# Sensor unit - bottom
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id,year) VALUES (" + str(
    d_id) + ", 10, 'NA', 387, 1, 12, " + str(s_bottom) + ",2012);")
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
...
# Sensor unit - top
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id,year) VALUES (" + str(
    d_id) + ", 10, 'NA', 388, 1, 13, " + str(s_top) + ",2012);")
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
# reading_info.append([abin, s_top, 10])
s_id += 1
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 11);")
...
# Sensor unit - bottom
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id,year) VALUES (" + str(
    d_id) + ", 10, 'NA', 391, 1, 13, " + str(s_bottom) + ",2012);")
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
# reading_info.append([abin, s_bottom, 10])
s_id += 1
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 11);")
...
# Sensor unit - top
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id,year) VALUES (" + str(
    d_id) + ", 10, 'NA', 346, 1, 30, " + str(s_top) + ",2012);")
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
# reading_info.append([abin, s_top, 10])
s_id += 1
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 11);")
...
# Sensor unit - bottom
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id,year) VALUES (" + str(
    d_id) + ", 10, 'NA', 312, 1, 30, " + str(s_bottom) + ",2012);")
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
# reading_info.append([abin, s_bottom, 10])
s_id += 1
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 11);")
...
print("INSERT INTO control (id,sensor_id,sensor_type_id,value,posted_datetime) VALUES (" + str(rc_id) + "," + str(
    pxr4_1_SP_id) + ",21,99,TIMESTAMP '" + postedTime.strftime('%Y-%m-%d %H:%M:%S') + "');")
rc_id += 1
postedTime = postedTime + timedelta(minutes=20)
fetchedTime = postedTime + timedelta(minutes=2)
print("INSERT INTO control (id,sensor_id,sensor_type_id,value,posted_datetime,fetched_datetime) VALUES (" + str(
    rc_id) + "," + str(pxr4_1_SP_id) + ",21,99,TIMESTAMP '" + postedTime.strftime(
    '%Y-%m-%d %H:%M:%S') + "',TIMESTAMP '" + fetchedTime.strftime('%Y-%m-%d %H:%M:%S') + "');")
