...
std_bins = list(range(12, 26))
std_bins.extend(list(range(30, 44)))
...
for fan_bin in fan_bins:
    # AB
    print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id) VALUES (" + str(
        d_id) + ", 14, 'AB', " + str(addr) + ", 0, " + str(fan_bin) + ", " + str(s_fan) + ");")
    ...
    # EA Tach
    print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id) VALUES (" + str(
        d_id) + ", 13, 'EA Tach', " + str(addr) + ", 5, " + str(fan_bin) + ", " + str(s_fan) + ");")
    addr += 1
...
for burner_bin in burner_bins:
    # Fuji
    print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id) VALUES (" + str(
        d_id) + ", 11, 'NA', " + str(addr) + ", 0, " + str(burner_bin) + ", " + str(s_burner) + ");")
    ...
    # Sensor unit
    print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id) VALUES (" + str(
        d_id) + ", 10, 'NA', " + str(addr) + ", 5, " + str(burner_bin) + ", " + str(s_burner) + ");")
...
# Outside bin
print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id) VALUES (" + str(
    d_id) + ", 10, 'NA', " + str(addr) + ", 5, 9, " + str(s_outside) + ");")
print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
...
for abin in std_bins:
    # Sensor unit - top
    print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id) VALUES (" + str(
        d_id) + ", 10, 'NA', " + str(addr) + ", 1, " + str(abin) + ", " + str(s_top) + ");")
    print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
    ...
    # Sensor unit - bottom
    print("INSERT INTO device (id, device_type_id, name, address, port, bin_id, bin_section_id) VALUES (" + str(
        d_id) + ", 10, 'NA', " + str(addr) + ", 2, " + str(abin) + ", " + str(s_bottom) + ");")
    print("INSERT INTO sensor (id, device_id, sensor_type_id) VALUES (" + str(s_id) + ", " + str(d_id) + ", 10);")
...
for i in range(99):
    ...
    print("INSERT INTO reading (id, datetime) VALUES (" + str(i) + ", TIMESTAMP '" + t.strftime(
        '%Y-%m-%d %H:%M:%S') + "');")
    for r in reading_info:
        rv = random.random() * 50.0 + 80.0
        if r[2] == 13:
            rv = int(rv) % 2
        print("INSERT INTO reading_data (reading_id, bin_id, bin_section_id, sensor_type_id, value) VALUES (" + str(
            i) + ", " + str(r[0]) + ", " + str(r[1]) + ", " + str(r[2]) + ", " + str(rv) + ");")
...
print(
    "INSERT INTO alarm_event (id,alarm_id, begin_datetime, end_datetime) VALUES (100,100, TIMESTAMP '" + tstart.strftime(
        '%Y-%m-%d %H:%M:%S') + "', TIMESTAMP '" + tend.strftime('%Y-%m-%d %H:%M:%S') + "');")
...
for a in range(100, 104):
    print("INSERT INTO alarm_contact (id,alarm_id,alarm_contact_type_id) VALUES (" + str(acCounter) + "," + str(
        a) + ",100);")
    acCounter += 1
    print("INSERT INTO alarm_contact (id,alarm_id,alarm_contact_type_id) VALUES (" + str(acCounter) + "," + str(
        a) + ",101);")
...
print(
    "INSERT INTO fill (id,fill_number,filled_datetime,air_begin_datetime,rotation_number,bin_id,hybrid_code,field_code,truck) VALUES (100,1,TIMESTAMP '" + tstart.strftime(
        '%Y-%m-%d %H:%M:%S') + "',TIMESTAMP '" + tstartair.strftime(
        '%Y-%m-%d %H:%M:%S') + "',1,12,'hybrid1','field1','truck1');")
tstart = tstart + timedelta(minutes=45)
tstartair = tstart + timedelta(minutes=15)
print(
    "INSERT INTO fill (id,fill_number,filled_datetime,air_begin_datetime,rotation_number,bin_id,hybrid_code,field_code,truck) VALUES (101,2,TIMESTAMP '" + tstart.strftime(
        '%Y-%m-%d %H:%M:%S') + "',TIMESTAMP '" + tstartair.strftime(
        '%Y-%m-%d %H:%M:%S') + "',1,13,'hybrid1','field1','truck1');")
