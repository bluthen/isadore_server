...
insert into account (email, password, seed, name, phone,  privilege_id) VALUES ('admin@example.com', encode(digest('example_seed_example_password', 'sha1'), 'hex'), 'example_seed', 'Your Name','15555555555', 2000);
